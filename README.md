...
```
*В корневой папке репозитория уже содержится эталонный файл графика производительности `vcore_performance_graph.png`, наглядно демонстрирующий кривую превосходства тензорных вычислений над стандартными библиотеками.*
